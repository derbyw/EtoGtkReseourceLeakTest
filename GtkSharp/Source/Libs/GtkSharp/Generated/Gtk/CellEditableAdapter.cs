...
#region Autogenerated code
	public partial class CellEditableAdapter : GLib.GInterfaceAdapter, Gtk.ICellEditable {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_editable_get_type();
		static d_gtk_cell_editable_get_type gtk_cell_editable_get_type = FuncLoader.LoadFunction<d_gtk_cell_editable_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_editable_get_type"));
